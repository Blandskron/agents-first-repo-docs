...
Esta habilidad debe activarse cada vez que un agente de IA necesite realizar una modificación en el prompt principal localizado en [agents-first-documentation-review.prompt.md](../../prompts/agents-first-documentation-review.prompt.md).
...
Realiza los cambios solicitados por el usuario directamente en el archivo [agents-first-documentation-review.prompt.md](../../prompts/agents-first-documentation-review.prompt.md). 
...
Sigue los pasos de verificación especificados en [TESTS.md](../../docs/agent/TESTS.md):
- Verifica que no queden referencias a archivos inexistentes o instrucciones de plataforma que no estén presentes en el repositorio.
